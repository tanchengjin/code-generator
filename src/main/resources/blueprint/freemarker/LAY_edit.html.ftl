...
<head>
    <meta charset="utf-8">
    <title>${tableInfo.comment}-编辑</title>
...
<#assign pojoName = "${underscoreToLowerCase(tableInfo.name)}">
<div class="layui-form" lay-filter="layuiadmin-form-role" id="layuiadmin-form-role" style="padding: 20px 30px 0 0;">

    <input type="hidden" name="${tableInfo.primaryKey}" value="${r"${"+pojoName+"."+(tableInfo.primaryKey)+"?c}"}">
